...
public class EmployeeService extends ServiceBase {
    ...
    public List<EmployeeView> getPerPage(int page) {
        List<Employee> employees = em.createNamedQuery(JpaConst.Q_EMP_GET_ALL, Employee.class)//ENTITY_EMP + ".getAll";
                .setFirstResult(JpaConst.ROW_PER_PAGE * (page - 1))//15;(1ページに表示するレコードの数)
    ...
    public long countAll() {
        long empCount = (long) em.createNamedQuery(JpaConst.Q_EMP_COUNT, Long.class)//ENTITY_EMP + ".count";
                .getSingleResult();
    ...
    public EmployeeView findOne(String code, String plainPass, String pepper) {
        ...
        try {
            ...
            e = em.createNamedQuery(JpaConst.Q_EMP_GET_BY_CODE_AND_PASS, Employee.class)//ENTITY_EMP + ".getByCodeAndPass";
                    .setParameter(JpaConst.JPQL_PARM_CODE, code)//"code";
                    .setParameter(JpaConst.JPQL_PARM_PASSWORD, pass)//"password";
                    .getSingleResult();
    ...
    public long countByCode(String code) {
        ...
        long employees_count = (long) em.createNamedQuery(JpaConst.Q_EMP_COUNT_REGISTERED_BY_CODE, Long.class)//ENTITY_EMP + ".countRegisteredByCode";
                .setParameter(JpaConst.JPQL_PARM_CODE, code)//"code";
                .getSingleResult();
